<section class="MostSellingProduct_wrapper">
        <div class="featured-product">
            <div class="container">
                <h3 class="section_heading m-bd text-center mb-41  text-green">Most Selling Product</h3>
                <div class="swiper featuredCardSwiper">
                    <div class="swiper-wrapper pb-90" id="customProductCardSlider2">
